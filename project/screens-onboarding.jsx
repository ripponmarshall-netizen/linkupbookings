...
function Onboarding() {
  ...
  return (
    <div style={{
      background: 'var(--paper)', minHeight: 720,
          ...
          {steps.map((s, i) => (
            <React.Fragment key={i}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                ...
                <span style={{ fontSize: 12, color: i === step ? 'var(--ink)' : 'var(--muted)', fontWeight: i === step ? 500 : 400 }}>{s}</span>
              </div>
              {i < steps.length - 1 && <div style={{ width: 24, height: 1, background: i < step ? 'var(--forest)' : 'var(--line)' }} />}
            </React.Fragment>
          ))}
        </div>
...
function OBWelcome({ onNext }) {
  return (
    <div style={{ textAlign: 'center' }}>
      ...
      <h1 className="serif" style={{ fontSize: 64, margin: '0 0 16px', lineHeight: 1, fontWeight: 400, letterSpacing: '-0.015em' }}>
        Welcome in.
      </h1>
      ...
      <div style={{
        display: 'flex', justifyContent: 'center', gap: 28, marginTop: 48,
...
function OBBusiness({ onNext }) {
  return (
    <div>
      <h2 className="serif" style={{ fontSize: 40, margin: '0 0 8px', fontWeight: 400, lineHeight: 1.05 }}>
        ...
        {Object.entries(hours).map(([d, [from, to, on]], i, arr) => (
          <div key={d} style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
              <button onClick={() => setHours({ ...hours, [d]: [from, to, !on] })}
                style={{
...
function OBLink() {
  return (
    <div style={{ textAlign: 'center' }}>
      ...
      <h1 className="serif" style={{ fontSize: 56, margin: '0 0 18px', lineHeight: 1.02, fontWeight: 400 }}>
      ...
      <div style={{
        ...
        <div style={{
          padding: '14px 18px', flex: 1, textAlign: 'left',
      ...
      <div style={{ display: 'flex', justifyContent: 'center', gap: 8, marginBottom: 36 }}>
        {[
          ...
          { l: 'Add to IG bio', i: Icon.globe, c: '#c4663d' },
