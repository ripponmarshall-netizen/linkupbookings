// Referral program — share with another owner, earn months free

function ReferralScreen({ isPro, onNav, onUpgrade, onShareLink }) {
  const referrals = [
...
window.ReferralScreen = ReferralScreen;
